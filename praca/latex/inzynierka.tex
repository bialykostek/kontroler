...
\begin{figure}[ht]
    \centering
    \subfloat{{\includegraphics[width=0.45\textwidth]{lewe1} }}
    \qquad
    \subfloat{{\includegraphics[width=0.45\textwidth]{prawe1} }}
...
\begin{figure}[ht]
    \centering
    \subfloat{{\includegraphics[width=0.45\textwidth]{proba1} }}
    \qquad
    \subfloat{{\includegraphics[width=0.45\textwidth]{proba2} }}
